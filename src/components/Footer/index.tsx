    ...
    return (
        <main>
            <div className="grid grid-cols-2 p-10">
                <Link to="/">
                <StaticImage
                    className="w-4/5 sm:w-1/3 md:w-1/3 xl:w-1/4 2xl:w-1/6 h-auto md:ml-[100px] xl:ml-[150px]"
            ...
            <hr className="w-[80%] mx-auto my-auto" />
            <div className="grid grid-cols-2 p-10">
                <div className="text-left md:ml-[100px] xl:ml-[150px]">
                    <span>
                        © {new Date().getFullYear()}, All right reserved.
                    </span>
                </div>
                <div className="text-right md:mr-[100px] xl:mr-[150px] space-x-4">
                    <FacebookOutlined />
                    <Instagram />
                    <X />
                    <LinkedIn />
