    ...
    <main className="flex justify-center w-full about-main">
      <div className="absolute z-10 grid grid-cols-2">
        <div className="flex flex-col ml-2 md:ml-36 space-y-10">
          <span className="text-white text-xl xl:text-5xl font-bold text-left lg:mt-20">{left_title}</span>
          <span className="text-white text-xs lg:text-base font-semibold text-left lg:w-5/6">{left_description}</span>
        ...
        <div className="flex flex-col mr-2 md:mr-36 space-y-10">
          <span className="text-white text-xl xl:text-5xl font-bold text-right lg:mt-20 xl:mt-48">{right_title}</span>
          <span className="text-white text-xs lg:text-base font-semibold text-right lg:w-5/6 ml-auto">{right_description}</span>
        </div>
      </div>
