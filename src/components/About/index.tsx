  ...
  return (
    <main id="about" className="flex justify-center w-full about-main -mb-20 md:mb-10 scroll-mt-20">
      <div className="absolute z-10 grid grid-cols-2 gap-x-10">
        <div className="flex flex-col ml-2 md:ml-16 lg:ml-20 xl:ml-20 2xl:ml-20 space-y-10">
          <span className="text-white text-lg md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold text-left lg:mt-20">{left_title}</span>
        ...
        <div className="flex flex-col mr-2 md:mr-16 lg:mr-20 xl:mr-20 2xl:mr-20 space-y-10">
          <span className="text-white text-lg md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold text-right lg:mt-40 xl:mt-48">{right_title}</span>
      ...
      <a className="absolute bottom-8 z-10 text-xl font-bold cursor-pointer text-black bg-secondary px-8 py-2 lg:px-12 lg:py-4 rounded-full hover:bg-yellow-300 transition delay-50 duration-200">
          <Link to="#contact" onClick={(e) => handleScroll(e, 'contact')}>Contactez nous</Link>
      </a>
      <div className="text-white background-1 h-[400px] md:h-[300px] lg:h-[600px] xl:h-[700px] 2xl:h-[800px]">
      </div>
      <div className="text-white background-2 h-[400px] md:h-[300px] lg:h-[600px] xl:h-[700px] 2xl:h-[800px]">
      </div>
      <StaticImage src="../../images/bg-about.jpeg"
          alt="Arrière-plan"
          placeholder="blurred"
          quality={100}
          className="background-3 h-[400px] md:h-[300px] lg:h-[600px] xl:h-[700px] 2xl:h-[800px] w-full z-0"
      />
      <StaticImage src={"../../images/svg/bg-about.svg"} alt={"Image Svg"}
          className="absolute z-50 right-0 w-[50px] md:w-[80px] lg:w-[140px] xl:w-[160px] 2xl:w-[180px] mr-2 mt-6 md:mr-2 md:mt-2 lg:mr-24 lg:mt-6 xl:mr-20 xl:mt-6 2xl:mr-20 2xl:mt-8"
      />
    </main>
  )
}
