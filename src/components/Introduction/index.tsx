...
const About = () => {
  ...
  return (
    <main className="relative animate-fadeIn container max-w-full flex flex-auto items-center justify-center mt-16 mb-52 lg:mb-52 xl:mb-72">
      <div className="z-10 text-xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl text-black font-bold text-center">
        ...
        <a href="#contact" onClick={(e) => handleScroll(e, 'contact')} className="text-base cursor-pointer mr-8 ml-8 md:mr-16 md:ml-16 lg:mr-20 lg:ml-20 xl:mr-20 xl:ml-20 text-black bg-secondary px-8 py-2 lg:px-12 lg:py-4 rounded-full hover:bg-yellow-300 transition-all duration-300 ease-linear">
